...
relation implies the logical relation. From this, a correctness
property for closure conversion follows: given any well-behaved
closure conversion function \AS{\_†}, a closed source term \AS{M}, and
a closed target term \AS{M†} which is the result of closure converting
\AS{M}, since \AS{M} and \AS{M†} are compatible, they reduce to
related values.
